  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-bold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:translate-y-[1px]",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-tomato text-primary-foreground hover:bg-tomato/90",
        outline: "border-2 border-foreground/15 bg-card hover:border-foreground/40 text-foreground",
        secondary: "bg-mustard text-foreground hover:bg-mustard/90",
        ghost: "hover:bg-foreground/5 text-foreground rounded-xl",
        link: "text-tomato underline-offset-4 hover:underline rounded-none",
      },
      size: {
